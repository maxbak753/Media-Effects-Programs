...
function [im_new, im_dct_new] = Discrete_Cosine_Tranform(imageName, p)
    ...
    % Read Image
    im = imread(imageName);   % 0 - 255 (original)
    im_n = im2double(im);       % 0 to 1 (n = normalized) (u[k,l])
